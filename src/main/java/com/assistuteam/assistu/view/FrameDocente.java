...
public class FrameDocente extends FramePanelBase {
    ...
    protected JButton[] getSideButtons() {
        ...
        botones[0] = setButton("Materias", 18, 350, 40);
     ...
     private void configurarAcciones() {
        botones[0].addActionListener(e -> JOptionPane.showMessageDialog(this, "Aquí se mostrarán las materias del docente"));
    ...
    // Grupos asignados en ventana modal con fondo temático y bordes redondeados
    private void mostrarGruposAsignados() {
        String[][] gruposAsignados = {
            {"Programación Orientada a Objetos", "3° \"B\"", "10:00 am – 14:00 pm"},
            {"Cálculo Integral", "2° \"A\"", "07:00 am – 11:00 am"}
        };

        JDialog dialog = new JDialog(this, "Grupos Asignados", true);
        dialog.setSize(520, 320);
        dialog.setLocationRelativeTo(this);
        dialog.setUndecorated(true); // Para bordes redondeados
        ...
        if (gruposAsignados.length == 0) {
            ...
            for (String[] grupo : gruposAsignados) {
                ...
                JLabel lblMateria = setLabel("Materia: " + grupo[0], 18, 1, 'L');
                lblMateria.setForeground(UIManager.getColor("bankya.color"));
                JLabel lblGrupo = setLabel("Grupo: " + grupo[1], 16, 3, 'L');
                lblGrupo.setForeground(UIManager.getColor("bankya.color"));
                JLabel lblHorario = setLabel("Horario: " + grupo[2], 16, 3, 'L');
        ...
        dialog.setContentPane(fondo);
        dialog.setBackground(new Color(0,0,0,0)); // transparente para los bordes redondeados
        dialog.setVisible(true);
    }
    ...
    protected JPanel buildCardsPanel() {
        ...
        panel.add(crearTarjetaDocente("Programación Orientada a Objetos", "Profesor. Sebastian Sosa", "10:00 am – 14:00 pm", 1));
        panel.add(crearTarjetaDocente("Cálculo Integral", "Materia Disponible", "07:00 am – 11:00 am", 2));
